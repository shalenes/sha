...
void useItem(int useTime){
    ...
    case 1:     //상처약
        if (potion.amount <= 0)
            ...
            printf("\"상처약\"을 사용했습니다. 체력이 10%% 회복됩니다.\n");
            potion.amount--;
            //상처약: 전체 체력의 10퍼 회복
            if(devmonNum==1){
    ...
    case 2:
        if (superPotion.amount <= 0)
            ...
            printf("\"좋은 상처약\"을 사용했습니다. 체력이 20%% 회복됩니다.\n");
            superPotion.amount--;
    ...
    case 3:
        if (hyperPotion.amount <= 0)
            ...
            printf("\"고급 상처약\"을 사용했습니다. 체력이 30%% 회복됩니다.\n");
            hyperPotion.amount--;
    ...
    case 4:
        if (maxPotion.amount <= 0)
            ...
            printf("\"풀 회복약\"을 사용했습니다. 체력이 모두 회복됩니다.\n");
            maxPotion.amount--; 
            //풀 회복약: 풀피
    ...
    case 5:
        if (mpPotion.amount <= 0)
            ...
            printf("\"mp 회복약\"을 사용했습니다. mp가 20%% 회복됩니다.\n");
            mpPotion.amount--;
            //mp 회복약: mp 20퍼 회복
            if(devmonNum==1){
    ...
    case 6:
        if (atkPotion.amount <= 0)
            printf("보유 중인 \"공격용 물약\"이 없습니다!\n");            
        else{
            printf("\"공격용 물약\"을 사용했습니다!\n");
            sleep(1);
            if(devmonNum==1){
                int tmpDMG;
                ...
                printf("%s의 체력이 %d만큼 감소했다!",myDevMon1.name,tmpDMG);
                if(myDevMon1.hp<=0){
                    myDevMon1.hp=0;
                }
            }
                ...
                myDevMon2.hp -= tmpDMG;
                printf("이런! 아군 개발몬에게 사용하면 어떻게 해!\n");
                printf("%s의 체력이 %d만큼 감소했다!",myDevMon2.name,tmpDMG);
                if(myDevMon2.hp<=0){
                    myDevMon2.hp=0;
                }
            }
                ...
                myDevMon3.hp -= tmpDMG;
                printf("이런! 아군 개발몬에게 사용하면 어떻게 해!\n");
                printf("%s의 체력이 %d만큼 감소했다!",myDevMon3.name,tmpDMG);
                if(myDevMon3.hp<=0){
                    myDevMon3.hp=0;
                }
            }
                ...
                printf("%s의 체력이 %d만큼 감소했다!",enemyDevmon.name,tmpDMG);
                if(enemyDevmon.hp<=0){
                    enemyDevmon.hp=0;
                }
            }
